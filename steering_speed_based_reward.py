...
def reward_function(params):
    ...
    # The angle of difference between the way our wheels are pointing and the direction we want them to point.
    steering_error = min(angle, 360 - angle)
    steering_penalty = min(steering_error / MAX_STEERING_ERROR, 1.0)
